package com.projects.mytodolistapp
...
import com.projects.mytodolistapp.databinding.ActivityMainBinding
import com.projects.mytodolistapp.databinding.UpdateDialogBinding
import com.projects.mytodolistapp.db.ToDo
import com.projects.mytodolistapp.db.WorksDatabase
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showUpdateDialog(id: Int) {
        ...
        binding.btnOK.setOnClickListener() {
            var newName: String = binding.etNewTodo.text.toString()
            GlobalScope.launch(Dispatchers.IO) {
